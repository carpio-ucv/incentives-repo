...
```{r setoptions, echo=FALSE, eval=TRUE, include=TRUE}
...
Higher numbers (closer to 9) represents expectations of negatives reactions whereas lower numbers (closer to 1) imply positive expectations.  
```{r}
