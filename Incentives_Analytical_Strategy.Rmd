...
ggplot(long_data, aes(x = factor(value), y = tot_exp2)) +
  ...
  geom_jitter(alpha = .5) +
  facet_grid( r_type ~ r_amount, margins = TRUE) +
...
g3data<-melt(final_df, measure.var= c("vd_0f","vd_1f","vd_2f"),id.var = c("tot_neg_eval"))

r<-ggplot(g3data, aes(tot_neg_eval, fill=factor(value)))+
        geom_histogram(colour="black")+
        scale_fill_brewer(palette="Set1")+
        theme_bw()
r
t<-ggplot(final_df, aes(tot_neg_eval, fill=r_type))+
        geom_histogram(colour="black")+
        scale_fill_brewer(palette="Set1")+
        theme_bw()

a<-ggplot(final_df, aes(tot_neg_eval, fill=r_amount))+
        geom_histogram(colour="black")+
        scale_fill_brewer(palette="Set1")+
        theme_bw()
par(mfrow=c(2,2))
